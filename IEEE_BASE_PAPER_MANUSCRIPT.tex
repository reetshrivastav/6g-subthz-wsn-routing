...
\begin{itemize}
    \item \textbf{Open-Source Codebase}: Complete simulation scripts, channel generators, and the self-contained benchmark notebook are hosted on GitHub: \url{https://github.com/Group2-6G-SubTHz/6g-subthz-wsn-routing}. A complete self-contained offline artifact package is provided alongside this manuscript.
    \item \textbf{Persistent Archival (Zenodo)}: A permanent Digital Object Identifier (DOI) will be minted via Zenodo integration upon public release.
